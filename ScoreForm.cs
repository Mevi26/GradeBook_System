...
namespace GradeBook_System
{
    public partial class ScoreForm : Form
    {
        ...
        {
            DataGridView_student.DataSource = score.getList(new MySqlCommand("SELECT score.StudentId, student.StdFirstName, student.StdLastName, score.Course, score.Score, score.Description FROM student INNER JOIN score ON score.StudentId=student.StdId"));
        }
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("The Score for this course is already exist", "Add Score", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
